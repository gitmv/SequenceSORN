...
NeuronGroup(net=net, tag='exc_neurons', size=getGrid(n_exc_neurons), color=blue, behavior={
...
NeuronGroup(net=net, tag='inh_neurons', size=getGrid(n_inh_neuros), color=red, behavior={
    # excitatory input
