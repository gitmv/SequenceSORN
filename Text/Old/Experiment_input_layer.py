...
class TextActivatorIL(Behavior):
...
#set_genome({'I': 13.948503053202911, 'L': 0.3053580855766736, 'S': 0.002204066589158092})
set_genome({'I': 13.854123826871724, 'L': 0.2655494182410093, 'S': 0.002092434302115935, 'E': 0.55})

ui = True
neuron_count = 2400
plastic_steps = 30000+20000
...
if __name__ == '__main__' and ui:
    ...
    #for i in range(20):
    #    train_ES_and_get_distribution_score(net, 5000)
