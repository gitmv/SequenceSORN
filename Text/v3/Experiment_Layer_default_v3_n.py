...
SynapseGroup(net=net, tag='IE,GLUI', src='exc_neurons1', dst='inh_neurons', behaviour={
    1: CreateWeights()
})

SynapseGroup(net=net, tag='EI,GABA', src='inh_neurons', dst='exc_neurons1', behaviour={
    1: CreateWeights()
})
...
if __name__ == '__main__' and ui:
    ...
    train_and_generate_text(net, input_steps=60000+1, recovery_steps=10000, free_steps=5000, sm=sm)