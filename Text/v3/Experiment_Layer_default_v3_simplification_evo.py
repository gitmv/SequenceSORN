...
ui = True
n_exc_neurons = 2400#3600#2400
n_inh_neuros = n_exc_neurons/10
grammar = ['abcde. ']#['fox eats meat. #', 'boy drinks juice. #', 'penguin likes ice. #'] #get_random_sentences(5)

target_act = 1/n_chars(grammar)/7#0.019230769230769232#
