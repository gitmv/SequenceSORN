...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behaviour={
    ...
    16: Text_Activator(input_density='[0.04#inpd]', strength='1.0'),#1.0 #0.75 #[0.9#IS]
    ...
    24: Synapse_Operation(transmitter='GABA', strength=-1),#[4.75#S]#'-0.72'

    # stability
    21: IP(sliding_window='0', speed='[0.007#IP]'),

    #learning
    25: Learning_Inhibition_mean2(strength='[31#LIM]', threshold='[0.377#th]', inh_attr='input_GABA'),  # 170#
...
inh_neurons = NeuronGroup(net=SORN, tag='inh_neurons', size=get_squared_dim(neuron_count/10), color=red, behaviour={
    2: Init_Neurons(),
    45: Synapse_Operation(transmitter='GLUI', strength=1),
