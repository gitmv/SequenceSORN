...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behavior={
    ...
    15: TextGenerator(text_blocks=get_default_grammar(4)),#get_bruno_grammar(20)
    ...
    41.5: LearningInhibition_mean(strength='[31#LIM]', threshold='[0.377#th]', use_inh=True),#'[25#LIM]'
