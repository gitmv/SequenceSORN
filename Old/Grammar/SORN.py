...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behavior={
    ...
    15: TextGenerator(text_blocks=get_default_grammar(3)),#get_bruno_grammar(20)
    16: TextActivator(input_density='0.04', strength='1.0'),
    ...
    #41.5: LearningInhibition_mean(strength='[10#LIM]', threshold='[0.379#th]', use_inh=True),#'0.015'#170 #0.02 -10 #0.19737532022 0.37994896225
    41.5: LearningInhibition_mean(strength='[15#LIM]', threshold='[0.43#th]', use_inh=True),#'0.015'#170 #0.02 -10 #0.19737532022 0.37994896225
