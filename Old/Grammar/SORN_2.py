...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behavior={
    ...
    #41.5: LearningInhibition_mean(strength='[170#LIM]', threshold='[0.02#th]', use_inh=False),#'0.015'#170 #0.02 -10 #0.19737532022 0.37994896225
    41.5: LearningInhibition_mean(strength='[25#LIM]', threshold='[0.13909244787#th]', use_inh=True),
