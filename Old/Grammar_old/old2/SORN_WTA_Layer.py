...
input_neurons = NeuronGroup(net=SORN, tag='input_neurons', size=None, color=yellow, behavior={
    ...
    #input
    11: TextGenerator(text_blocks=get_default_grammar(3), set_network_size_to_alphabet_size=True),#, ' man drives car.', ' plant loves rain.'
...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behavior={
    ...
    #input
    16: input_SynapseOperation(input_density=0.04, strength=1.0),
