...
plastic_steps = 60000#30000
recovery_steps = 5000

SORN = Network(tag='SORN_Layer_big')

#' abcdefghij', ' klmnopqr', ' stuvwxyz', ' jihgfedcba', ' rqponmlk', 'zxywvuts'] 'uvwx', ' efgh', ' ijkl', ' mnop', ' qrst', ' uvwx', ' yz12'
#[' abcd', ' efgh', ' ijkl', 'mnop', ' qrst', ' uvwx', ' yz12']
#[' abcd efgh ijkl.', ' yz12 efgh mnop.', 'qrst uvwx yz12.', 'qrst uvwx mnop.']
#[' abcd', ' efgh', ' ijkl', 'mnop', ' qrst', ' uvwx', ' yz12']
input_neurons = NeuronGroup(net=SORN, tag='input_neurons', size=None, color=yellow, behavior={
    #init
    1: Init_Neurons(),

    #input
    11: TextGenerator(text_blocks=get_default_grammar(3), set_network_size_to_alphabet_size=True),#get_grammar_blocks(56) #, get_bruno_grammar(14)
...
exc_neurons = NeuronGroup(net=SORN, tag='exc_neurons', size=get_squared_dim(neuron_count), color=blue, behavior={
    ...
    #input
    16: input_SynapseOperation(input_density=96, strength='[0.75#is]'),#0.5 #0.04 #0.75 #1.0
