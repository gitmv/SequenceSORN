...
e_ng = NeuronGroup(net=SORN, tag='PC_{},prediction_source'.format(1), size=get_squared_dim(N_e), behavior={
    ...
    5: init_afferent_synapses(transmitter='GLU_cluster', density='40%', distribution='uniform(0.1,1.0)',
                              normalize=True),
    ...
    20: IP(h_ip='lognormal_real_mean([0.02#IP_mean], [0.2944#IP_sigma])', eta_ip='[0.007#IP_eta]', target_clip_min=None,
