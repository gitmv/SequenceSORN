...
exc_neurons = NeuronGroup(net=SORN, tag='PC_{},prediction_source'.format(1), size=get_squared_dim(N_e), behaviour={
    ...
    8: Text_Generator(text_blocks=[' fox eats meat.', ' boy drinks juice.', ' penguin likes ice.']),
    9: Text_Activator(input_density=0.015),
    ...
    21: STDP_complex(transmitter='GLU', eta_stdp='[0.00015#STDP_eta]', STDP_F={-1: 1, 1: -1}),#{-1: 0.2, 1: -1}
