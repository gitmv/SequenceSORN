...
#smg = StorageManagerGroup('original_default_newSC_with_data_storage')
...
i_activity = sm.load_np('inh_n._activity')
plt.hist(i_activity.flatten(), bins=1000)
plt.show()
